...
To finalize the set-up for publishing to PyPI, see [here](https://joeblackwaslike.github.io/spinup-py/features/publishing/#set-up-for-pypi).
For setting up the Docusaurus documentation site, see the [docs/](docs/) directory.
To enable the code coverage reports, see [here](https://joeblackwaslike.github.io/spinup-py/features/codecov/).
...
For more details, see [here](https://joeblackwaslike.github.io/spinup-py/features/cicd/#how-to-trigger-a-release).
{%- endif %}

---

Repository initiated with [joeblackwaslike/spinup-py](https://github.com/joeblackwaslike/spinup-py).
